...
async function generateScript(theme) {
  const response = await fetch("https://openrouter.ai/api/v1/chat/completions", {
    ...
    body: JSON.stringify({
      ...
      messages: [{
        role: "user",
        content: `Tu es expert TikTok viral. Crée 1 vidéo courte sur le thème: "${theme}".
Réponds UNIQUEMENT en JSON valide (sans markdown) avec ce format:
{
  "hook": "phrase choc courte",
  "tips": ["conseil 1", "conseil 2", "conseil 3"],
  "cta": "phrase de conclusion avec appel à l'action",
  "capcut": "[0s] TEXTE\\n[5s] TEXTE\\n[10s] TEXTE\\n[15s] TEXTE\\n[20s] TEXTE",
  "hashtags": "#hashtag1 #hashtag2 #hashtag3 #hashtag4 #hashtag5",
  "description": "description TikTok optimisée"
}`
      }]
    })
  });
